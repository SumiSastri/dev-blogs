...
[Read this section in conjunction with Part 3 - Computer shells the difference between Bash and Zish](https://sumisastri.github.io/dev-blogs/dev-environment/part3-computer-shells/)
