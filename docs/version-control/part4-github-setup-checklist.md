...
1. This ensures you upgrade Git more easily, CLI [https://git-scm.com/book/en/v2/Getting-Started-Installing-Git]
...
- Configure your name and email address for commits (be sure to use the email address you have registered with Github) not the email that is your personal/ office email

Connect a work Github to your local machine:
